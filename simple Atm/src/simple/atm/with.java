...
public class with  {
    ...
    public with(Account a) {
        this.a = a;
    }
   
   public Scene s(Stage primaryStage) 
    {
         Image image = new Image(getClass().getResourceAsStream("withdraw.jpg"), 1200, 1200, false, false);
        ...
        Image i92 = new Image(getClass().getResourceAsStream("withdraw.jpg"), 100, 100, false, false);
